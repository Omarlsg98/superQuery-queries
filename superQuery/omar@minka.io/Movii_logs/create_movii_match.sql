            ...
            IF (transfer_status IN ("COMPLETED")
                ...
                IF(source_bank="Movii"
                    ,CASE
                        ...
                        WHEN cico_source_balance!=-1 AND dwup_source_balance=-1 THEN CONCAT(" ",match_source,IF(match_source<0,"_cashin","_cashout"),"_source")
                ...
                IF(target_bank="Movii"
                    ,CASE
                        ...
                        WHEN cico_target_balance!=1 AND dw_target=1 THEN CONCAT(" ",match_target,IF(match_target<0,"_cashin","_cashout"),"_target")
            ...
            ,IF (transfer_status IN ("REJECTED")
                ...
                IF(source_bank="Movii"
                    ,CASE
                        ...
                        WHEN cico_source_balance!=0 AND dwup_source_balance=0 THEN CONCAT(" ",match_source,IF(match_source<0,"_cashin","_cashout"),"_source")
                ...
                IF(target_bank="Movii"
                    ,CASE
                        ...
                        WHEN cico_target_balance!=0 AND dw_target=0 THEN CONCAT(" ",match_target,IF(match_target<0,"_cashin","_cashout"),"_target")
